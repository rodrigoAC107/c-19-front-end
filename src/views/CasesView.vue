...
<template>
  <LayoutVertical>
    ...
    <div
      v-if="!isLoading"
      class="flex w-full min-h-full justify-center content-center"
    >
        ...
        <table class="table-auto w-full h-1/2 text-center rounded-t-lg">
          ...
          <tbody class="divide-y-2 divide-gray-200">
            ...
            >
              ...
              <td class="p-1 capitalize">{{ data.current_state }}</td>
              <td class="p-1">{{ data.age }} años</td>
              <td class="p-1">
                <span :class="data.triage.toLowerCase()">
                  {{ data.triage }}
                </span>
              </td>
              <td
                @click="showModalCase(data._id)"
